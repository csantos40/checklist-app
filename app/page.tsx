...
const TASK_DATA = {
  ...
  'Gerente': [
    ...
    { description: 'MENSAL: Comercial (Levar sugestões de ofertas agressivas ao comercial, como itens próximo de vencimento, levantar as informações ao repassar aos setores)', periodicity: 'MENSAL' },
    { description: 'MENSAL: SEXTA 14:00h- Comercial - Lista de produtos com validade curta 7 dias (trabalhar com plano de ação, rebaixe de preço, exposição, cartazeamento, estoques)', periodicity: 'MENSAL' },
